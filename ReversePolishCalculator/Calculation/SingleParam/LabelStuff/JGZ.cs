...
{
    /// <summary>
    ///     Jumps to a label if the number is greater than zero.
    ///     example 1 JLZ
    /// </summary>
    internal class JGZ : Method
    {
        public JGZ() : base("JGZ", 2)
        {
        }

        /// <summary>
        ///     Sets the global LNR to the of the wanted label only when the first parameter is greater than 0.
        /// </summary>
